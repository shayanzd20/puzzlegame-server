...
//                            $city = trim($decode->city);
                        ...
                        //Name
                        $scoreName = 0;
                        if ($this->Check->checkWord($Char, $Cat = 'Name')) {
                        ...
                        //Family
                        $scoreFamily = 0;
                        if ($this->Check->checkWord($Char, $Cat = 'Family')) {
                        ...
                        //Car
                        $scoreCar = 0;
                        if ($this->Check->checkWord($Char, $Cat = 'Car')) {
                        ...
                        //Animal
                        $scoreAnimal = 0;
                        if ($this->Check->checkWord($Char, $Cat = 'Animal')) {
                        ...
                        //Flower
                        $scoreFlower = 0;
                        if ($this->Check->checkWord($Char, $Cat = 'Flower')) {
...
//                            echo "INSERT INTO `user_word` (`UserID`,`RoomID`,`Word`,`WordOrg`,`Cat`,`Score`) VALUES ('$username','$id','$decode->flower','گل','$scoreFlower')"."\n";
                        ...
                        //Color
                        $scoreColor = 0;
                        if ($this->Check->checkWord($Char, $Cat = 'Color')) {
                        ...
                        //City
                        $scoreCity = 0;
                        if ($this->Check->checkWord($Char, $Cat = 'City')) {
...
//                        ) {
                        ...
                        if ($this->Check->checkWord($Char, $Cat = 'Name')) {
                            $validNameMes = 1;
                            if ($this->Check->checkWordWithCat($name, $Char, $Cat = 'Name')) {
                                $validName = 1;
                                $validNameMes = 2;
                        ...
                        if ($this->Check->checkWord($Char, $Cat = 'Family')) {
                            $validFamilyMes = 1;
                            if ($this->Check->checkWordWithCat($family, $Char, $Cat = 'Family')) {
                                $validFamilyMes = 2;
                                $validFamily = 1;
                            }
                        }
                        if ($this->Check->checkWord($Char, $Cat = 'Car')) {
                            $validCarMes = 1;
                            if ($this->Check->checkWordWithCat($car, $Char, $Cat = 'Car')) {
                                $validCarMes = 2;
                                $validCar = 1;
                            }
                        }
                        if ($this->Check->checkWord($Char, $Cat = 'Animal')) {
                            $validAnimalMes = 1;
                            if ($this->Check->checkWordWithCat($animal, $Char, $Cat = 'Animal')) {
                                $validAnimalMes = 2;
                                $validAnimal = 1;
                            }
                        }
                        if ($this->Check->checkWord($Char, $Cat = 'Flower')) {
                            $validFlowerMes = 1;
                            if ($this->Check->checkWordWithCat($flower, $Char, $Cat = 'Flower')) {
                                $validFlowerMes = 2;
                                $validFlower = 1;
                            }
                        }
                        if ($this->Check->checkWord($Char, $Cat = 'Color')) {
                            $validColorMes = 1;
                            if ($this->Check->checkWordWithCat($color, $Char, $Cat = 'Color')) {
                                $validColorMes = 2;
                                $validColor = 1;
                            }
                        }
                        if ($this->Check->checkWord($Char, $Cat = 'City')) {
                            $validCityMes = 1;
                            if ($this->Check->checkWordWithCat($city, $Char, $Cat = 'City')) {
                                $validCityMes = 2;
                                $validCity = 1;
                            }
                        }
